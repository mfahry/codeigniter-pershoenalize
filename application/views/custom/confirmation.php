	...
	<body>
		...
		<div class="row" style="padding:20px;">
			<div class="col-xs-6 col-xs-offset-3" style="font-family: 'Cambria';">
				<form method="post" enctype="multipart/form-data" action="<?php echo base_url("custom/confirmation_process")?>">
					<table>
						<tr>
							<td style="font-family: 'Cambria'; font-size:12px; padding:5px;">Order Number</td>
							<td style="font-family: 'Cambria'; font-size:12px; padding:5px;"> : </td>
							<td style="padding:5px;"><input type="text" name="order_number" class="form-control" style="font-family: 'Cambria'; font-size:12px;"/></td>
						</tr>
						<tr>
							<td style="font-family: 'Cambria'; font-size:12px; padding:5px;">Payment Evidence</td>
							<td style="font-family: 'Cambria'; font-size:12px; padding:5px;"> : </td>
							<td style="padding:5px;"><input type="file" name="confirmation_path" style="font-family: 'Cambria'; font-size:12px;"/></td>
						</tr>
						<tr>
							<td style="font-family: 'Cambria'; font-size:12px; padding:5px;"></td>
							<td style="font-family: 'Cambria'; font-size:12px; padding:5px;"></td>
							<td style="padding:5px;"><input type="submit" value="submit" style="font-family: 'Cambria'; font-size:12px;" class="btn btn-success"/></td>
						</tr>
					</table>
				</form>
			</div>
