...
================================================== -->
  <body>
	...
	<h1 align="center" style="font-family:AG_Futura;color:#585858;">PAYMENT VERIFICATION</h1>
	<br/>
	<div class="container">
		<div class="row">
			<div align="center" style="width:360px;position:center;margin-left:405px;">
				<nav class="main">
					<div class="row">
						<form role="form" action="<?php echo base_url("custom/confirmation");?>" method="POST">
						<div class="form-group">	
							<label for="exampleFirstName">Verification Code <sup><font color="red"> * </font></sup></label>
							<input class="form-control" type="text" name="first_name" id="exampleFirstName" placeholder="First Name">
						</div>
						<div class="form-group">	
						  <label for="exampleLastName">Payment Avidence<sup><font color="red"> * </font></sup></label>
						  <input type="file" name="last_name" id="exampleLastName">
						</div>
						<button type="submit" class="btn btn-success">Verification Now!</button>
						</form>
					</div>
				</nav>
			</div>
