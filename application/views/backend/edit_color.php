...
<script>  
 ...
 <form action="<?php echo base_url("color/edit_process");?>" method="post" enctype="multipart/form-data" role="form" id="form-one">
				...
				<td style="font-family:Candara; font-size:13px; padding:5px;">	
					<table style="width:100%; align:left;">
						<tr>
							...
							<td>
								<input type="text" name="color_name" maxLength="50" size="25" value="<?php echo $color->color_name; ?>" class="form-control"/>
							</td>
						</tr>
					</table>
				</td>
