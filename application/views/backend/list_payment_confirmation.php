		...
		<table class="table" width="100%">
			<thead>
				<tr>
					...
					<th style="color:rgba(30, 135, 75, 0.95); font-size:15px; font-family:'Broadway'"><center>ORDER NUMBER</center></th>
					<th style="color:rgba(30, 135, 75, 0.95); font-size:15px; font-family:'Broadway'"><center>CONFIRMATION PATH</center></th>
			...
			<tbody>
				...
				{
					$no = 1;
					foreach($payment_confirmation->result()  as $row)
					{ ?>
						<tr style="font-family:Candara; font-size:13px; padding:5px;">
							<td class="text-center"><?php echo $no++; ?></td>
							<td><?php echo $row->order_number; ?></td>
							<td><a href="<?php echo base_url("uploads/confirmation/".$row->confirmation_path); ?>"><?php echo $row->confirmation_path; ?></a></td>
							<td align="center"><a rel="<?php echo base_url("user/delete?order_number=".$row->order_number); ?>" class="btn btn-danger" title="delete"><span class="glyphicon glyphicon-remove"></span> Delete</a></td>
						</tr>	
					<?php
					}
				} 
