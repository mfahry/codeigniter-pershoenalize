...
<body>
	...
	<div id="content" style="height:450px;"><br/><br/><br/><br/>
		<center>
			...
			<h1 style="letter-spacing:3px;"><font size="20" face="Century Gothic"><b>Member</b></font></h1><br/>
		...
		<br/><br/>
		<form action="<?php echo base_url("user/login_process_member");?>" method="POST" id="login-form">
			<fieldset>
				<p>
					<input name="email" type="text" id="login-username" class="round full-width-input" placeholder="Username"/>
				</p>
				<p>
					<input name="password" type="password" id="login-password" class="round full-width-input" placeholder="Password" />
				</p>
				<p>I don't have <a href="<?php echo base_url("user/register_member");?>">Pershoenalize Member Account</a>.</p>
				<input type="submit" class="button round blue" value="LOGIN"/>
			</fieldset>
		</form>
		<center>
