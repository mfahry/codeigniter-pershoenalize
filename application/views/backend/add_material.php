...
<script>  
	...
	function add_textfield_material(){
		$("#form-material").append("<hr/><input type='text' name='material_name[]' maxLength='50' size='25' class='form-control'/>");
	}
	
</script>

 <form action="<?php echo base_url("material/add_process");?>" method="post" enctype="multipart/form-data" role="form" id="form-one">
				...
				<td style="font-family:Candara; font-size:13px; padding:5px;">	
					<table style="width:100%; align:left;">
						<tr>
							...
							<a onclick="add_textfield_material();" class="btn btn-warning" style="margin-top: 5px;"><span class="glyphicon glyphicon-plus-sign"></span> input box</a>
							</td>
						</tr>
					</table>
				</td>
