<script>
	function paging(startWith, limit, dataUrl){
		$("#group-parts").hide();
		$("#group-parts").load(dataUrl+"?start_with="+startWith+"&limit="+limit);
		$("#group-parts").show(1000);
	}
			...
			<table>		
					<tr>
						<td rowspan="3" style="font-family:Candara; font-size:13px; padding:0px 5px;">
							<img src="<?php echo base_url("uploads/part_type/".$row->part_type_path);?>" class="img-thumbnail" style="width:220px; height:180px; margin-bottom:5px;"/> 
							<div class="text-center">
								<a class="btn btn-success" onclick="modalFormOne('<?php echo base_url("part_type/edit?part_type_id=".$row->part_type_id)?>')"><span class="glyphicon glyphicon-pencil"></span> Edit</a> 
								<a class="btn btn-danger" onclick="modalDeleteOne('<?php echo base_url("part_type/delete?part_type_id=".$row->part_type_id)?>')"><span class="glyphicon glyphicon-remove"></span> Delete</a>
							</div>
						</td>
						<td rowspan="3" style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top">
							<table>
								<tr>
									...
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top"><?php echo $row->part_type_name; ?></td>
								</tr>
								<tr>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px; font-weight:bold;" valign="top">Shoe</td>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top"> : </td>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top"><?php echo $row->shoe_name; ?></td>
								</tr>
								<tr>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px; font-weight:bold;" valign="top">Type</td>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top"> : </td>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top"><?php echo $row->part_type_group_name; ?></td>
								</tr>
								<tr>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px; font-weight:bold;" valign="top">Path</td>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top"> : </td>
									<td style="font-family:Candara; font-size:13px; padding:0px 5px;" valign="top">uploads/part_type/<?php echo strtolower($row->part_type_path); ?></td>
								</tr>
							</table>
						</td>
					</tr>
...
<ul class="pager">
	...
	if($count <= 10){}
		...
		<li class="previous" style="cursor:pointer;"><a onclick="paging('<?php echo ($start_with-10); ?>','10','<?php echo base_url("part_type/view_limit")?>')">&larr; Older</a></li>
		<li class="next" style="cursor:pointer;"><a onclick="paging('<?php echo ($start_with+10); ?>','10', '<?php echo base_url("part_type/view_limit")?>')">Newer &rarr;</a></li>
	<?php
	}
