...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
		...
		<div class="container">
			...
			<br/>
			<h1 align="center" style="font-family:AG_Futura;color:#585858;">MAIN HEADER</h1>
			<br/>
		...
		<div class="container">	
			<div align="center" style="width:860px;position:center;margin-left:135px;">
				<div style="text-align: center; border-top: 1px solid black; width:890px;">
					<div style="display: inline-block; position: relative; top: -40px; background-color: white; padding: 0px 10px">	
						<h2 align="center" style="font-family:AG_Futura;color:#585858;">SUB HEADER 2</h2>
					</div>
				</div>
				<nav class="main">
					<div class="row">
		...
		<div class="container">	
			<div align="center" style="width:860px;position:center;margin-left:135px;">
				<div style="text-align: center; border-top: 1px solid black; width:890px;">
					<div style="display: inline-block; position: relative; top: -40px; background-color: white; padding: 0px 10px">	
						<h2 align="center" style="font-family:AG_Futura;color:#585858;">SUB HEADER 3</h2>
					</div>
				</div>
				<nav class="main">
					<div class="row">
		...
		<div class="container">	
			<div align="center" style="width:890px;position:center;margin-left:135px; width:890px;">
				<div style="text-align: center; border-top: 1px solid black">
					<div style="display: inline-block; position: relative; top: -40px; background-color: white; padding: 0px 10px">	
						<h1 align="center" style="font-family:AG_Futura;color:#585858;">RELATED ARTICLES</h1>
					</div>
				</div>
			</div>
		</div>
