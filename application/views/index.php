...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
		...
		<div class="container">
			...
			<div class="container">
				<div class="row" style="margin-left:105px;">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="width:900px;height:425px;">
					<!-- Indicators -->
					...
					<div class="carousel-inner">
						<div class="item active">
							<a href="<?php echo base_url("welcome/generator")?>">
								<img src="<?php echo base_url("assets/img/page_1.jpg")?>" alt="..." style="width:900px;height:425px;"/>
						...
						<div class="item">
							<a href="<?php echo base_url("welcome/inspireme")?>">
								<img src="<?php echo base_url("assets/img/page_2.jpg")?>" alt="..." style="width:900px;height:425px;" />
								<div class="carousel-caption">
								...
							</a>
							</div>
		...
		<br/><br/><br/>
		<div class="container">	
			<div align="center" style="width:900px;position:center;margin-left:105px; width:900px;">
				<div style="text-align: center; border-top: 1px solid black">
					<div style="display: inline-block; position: relative; top: -40px; background-color: white; padding: 0px 10px">	
						<h1 align="center" style="font-family:AG_Futura;color:#585858;">OUR SERVICES</h1>			
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">	
			<div align="center" style="width:900px;position:center;margin-left:105px; width:900px;">
				<div style="text-align: center; border-top: 1px solid black">
					<div style="display: inline-block; position: relative; top: -40px; background-color: white; padding: 0px 10px">							
						<h1 align="center" style="font-family:AG_Futura;color:#585858;">OUR CAMPAIGN</h1>			
					</div>
				</div>
			</div>
		</div>
